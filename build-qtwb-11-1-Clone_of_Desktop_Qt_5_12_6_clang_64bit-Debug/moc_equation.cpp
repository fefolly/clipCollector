/****************************************************************************
** Meta object code from reading C++ file 'equation.h'
**
...
#include "../MonCal/equation.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'equation.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Equation_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject Equation::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Equation.data,
    qt_meta_data_Equation,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Equation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Equation.stringdata0))
